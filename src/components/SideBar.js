...
const SideBar = () => {
    ...
    const sideBarItems = [
        { name: "Home", iconSrc: "https://img.icons8.com/material-sharp/24/ffffff/home.png", id: "Videos%202024" },
        ...
        {name:"Live",iconSrc:"https://img.icons8.com/windows/32/ffffff/youtube-live.png",id:"Live%202024"}
    ];

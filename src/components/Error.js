...
const Error = () => {
  return (
    <div className="text-[14px] sm:text-[16px] flex flex-col w-full h-screen justify-center items-center px-2 bg-black">
        ...
        <p className='flex text-white font-bold p-5'>Our apologies❗Due to exceeding our daily API quota, data retrieval is currently unavailable. Service will resume tomorrow at 1 PM 🕒.</p>
        </div>
        </div>
  )
}
